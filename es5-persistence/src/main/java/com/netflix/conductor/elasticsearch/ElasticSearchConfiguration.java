...
public interface ElasticSearchConfiguration extends Configuration {
    ...
    String ELASTIC_SEARCH_INDEX_SETTINGS_FILE_PROPERTY_NAME = "workflow.elasticsearch.index.shard.count";
    String ELASTIC_SEARCH_INDEX_SETTINGS_FILE_DEFAULT_VALUE = "index_settings.json";
    ...
    default String getElasticSearchIndexSettingsFile()
    {
        return getProperty(ELASTIC_SEARCH_INDEX_SETTINGS_FILE_PROPERTY_NAME,
                              ELASTIC_SEARCH_INDEX_SETTINGS_FILE_DEFAULT_VALUE);
    }
}
